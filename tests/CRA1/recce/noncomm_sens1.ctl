# Control file for RL model Sept-Oct 2014
# run description (one word only)
CRA1Recreationalsens1
...
1
# for each tag data set, which region's biomass is used in dd growth calcs
1 
# names of regions data files (all one line, max length is 80)
CRA1_noncomm_sens1-bin238.dat 
...
#  7 Likelihood weights (extra is penal for exceeding max. ExRate )
# if you change a switch here CHECK PHASES BELOW!!
#      LFs   Tag       CPUE    PRI      CR   Poo       U
         1      1       1       0       0    0
         10     7       2       2       2    1
         14    0.7     2.8      1       7   0.2   1000000
